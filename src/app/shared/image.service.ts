...
export class ImageService{
  ...
  constructor(){
    this.visibleImages = IMAGES.sort((item1: any, item2: any) => {
  ...
  getImage(title: string){
    return IMAGES.slice(0).find(image => image.title == title)
  }
...
const IMAGES = [{
    ...
    "title": "Paris - Trocadéro - 24-12-2007 - 21h33",
    ...
    "title": "Trocadéro - 7-04-2007 - 7h04",
